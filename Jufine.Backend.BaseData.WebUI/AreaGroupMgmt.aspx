<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="True" CodeBehind="AreaGroupMgmt.aspx.cs" Inherits="Jufine.Backend.BaseData.WebUI.AreaGroupMgmt" %>
...
<tr>                <td style="width: 60px;">
                ...
                <td style="width: 60px;">
                    ...
                    <td>
                        <asp:TextBox ID="stxtAreaID" PropertyName="AreaID" Width="300" runat="server"></asp:TextBox>
                    </td>
    ...
    <asp:UpdatePanel ID="upList" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
        <contenttemplate>
                    <asp:GridView ID="gvAreaGroupList" 
                        runat="server" 
                        OnSorting="gvAreaGroupList_Sorting" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="GroupCode" HeaderText="GroupCode" SortExpression="GroupCode" ItemStyle-Width="60" />
                            <asp:BoundField DataField="GroupName" HeaderText="GroupName" SortExpression="GroupName" ItemStyle-Width="60" />
                            <asp:BoundField DataField="AreaID" HeaderText="AreaID" SortExpression="AreaID" ItemStyle-Width="60" />
...
<tr>                                                        <td style="width: 60px;">
                                                        ...
                                                        <td style="width: 60px;">
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtGroupName" PropertyName="GroupName" MaxLength="50" Width="200" runat="server"></asp:TextBox>
                                                            </td>
                                                        ...
                                                        <td style="width: 60px;">
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="txtAreaID" PropertyName="AreaID" MaxLength="4" Width="200" runat="server"></asp:TextBox>
                                                            </td>
